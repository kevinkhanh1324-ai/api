...
# Database configuration - supports environment variables for cloud deployment
DB_SERVER = os.getenv("DB_SERVER", "localhost")
DB_USER = os.getenv("DB_USER", "sa")
DB_PASSWORD = os.getenv("DB_PASSWORD", "12345")
DB_NAME = os.getenv("DB_NAME", "apidb")

# Use pymssql for Render (pure Python, no compilation needed)
# For local development with SQLite, set USE_SQLITE=true
...
if USE_SQLITE:
    ...
    # Local development - uses pyodbc if available
    try:
